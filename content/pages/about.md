...
<span style="color:rosybrown">Frontend development for a fintech startup which provides all-in-one finance solutions in Southeast Asia. Xfers (YC S15) and Payfazz (YC S17) merged to form Fazz Financial Group. (with 10M active users per month)</span>\
...
<span style="color:rosybrown">Frontend development for a startup to provide solutions for managing electric charging networks.</span>\
